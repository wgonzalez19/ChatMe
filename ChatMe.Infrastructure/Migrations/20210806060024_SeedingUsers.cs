    ...
    public partial class SeedingUsers : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("26f40fdf-8f92-4c4f-80c1-71090d86aef4"), "jpPI/BQPEbRdb6hJhlA2kwlqdbA=", "Will" });

            migrationBuilder.InsertData(
                schema: "ChatMe",
                table: "Users",
                columns: new[] { "Id", "Password", "Username" },
                values: new object[] { new Guid("1b0f8308-feb0-4d55-93ec-0765971e0bb7"), "jpPI/BQPEbRdb6hJhlA2kwlqdbA=", "Test" });
        }
